...
`,no=o=>{if(!o||!o.link||o.link===void 0||o.link==="undefined")return null;let{link:e,timestamp:t,fileName:r}=o;return b`<a
  ...
  >
    ...
    `}getMetadata(){return{fileName:this.documentNode.name,timestamp:this.documentNode.lastModified,link:this.link}}connectedCallback(){super.connectedCallback(),this.documentNode&&(ot(this,we,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom()))}updated(e){super.updated(e),e.has("documentNode")&&(ot(this,we,"f").call(this),this.selectedPage&&(this.__updateTree(this.selectedPage),this.resetZoom())),e.has("renderedImages")&&this.__updateEffectMargins()}};we=new WeakMap,rt=new WeakMap;co([E({type:Object,attribute:"document-node"})],D.prototype,"documentNode",void 0);co([E({type:Object,attribute:"rendered-images"})],D.prototype,"renderedImages",void 0);customElements.get("figspec-file-viewer")||customElements.define("figspec-file-viewer",D);customElements.get("figspec-frame-viewer")||customElements.define("figspec-frame-viewer",U);var Tr=new Set(["children","localName","ref","style","className"]),ho=new WeakMap,Pr=(o,e,t,r,i)=>{let s=i?.[e];s===void 0||t===r?t==null&&e in HTMLElement.prototype?o.removeAttribute(e):o[e]=t:((n,c,a)=>{let d=ho.get(n);d===void 0&&ho.set(n,d=new Map);let l=d.get(c);a!==void 0?l===void 0?(d.set(c,l={handleEvent:a}),n.addEventListener(c,l)):l.handleEvent=a:l!==void 0&&(d.delete(c),n.removeEventListener(c,l))})(o,s,t)},kr=(o,e)=>{typeof o=="function"?o(e):o.current=e};function $e(o=window.React,e,t,r,i){let s,n,c;if(e===void 0){let f=o;({tagName:n,elementClass:c,events:r,displayName:i}=f),s=f.react}else s=o,c=t,n=e;let a=s.Component,d=s.createElement,l=new Set(Object.keys(r??{}));class h extends a{constructor(){super(...arguments),this.o=null}t(m){if(this.o!==null)for(let x in this.i)Pr(this.o,x,this.props[x],m?m[x]:void 0,r)}componentDidMount(){var m;this.t(),(m=this.o)===null||m===void 0||m.removeAttribute("defer-hydration")}componentDidUpdate(m){this.t(m)}render(){let{_$Gl:m,...x}=this.props;this.h!==m&&(this.u=_=>{m!==null&&kr(m,_),this.o=_,this.h=m}),this.i={};let S={ref:this.u};for(let[_,Me]of Object.entries(x))Tr.has(_)?S[_==="className"?"class":_]=Me:l.has(_)||_ in c.prototype?this.i[_]=Me:S[_]=Me;return S.suppressHydrationWarning=!0,d(n,S)}}h.displayName=i??c.name;let u=s.forwardRef(((f,m)=>d(h,{...f,_$Gl:m},f?.children)));return u.displayName=h.displayName,u}var po=$e(le,"figspec-frame-viewer",U,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"}),uo=$e(le,"figspec-file-viewer",D,{onNodeSelect:"nodeselect",onPositionChange:"positionchange",onScaleChange:"scalechange"});var Qc=__STORYBOOK_API__,{ActiveTabs:ed,Consumer:td,ManagerContext:od,Provider:rd,RequestResponseError:id,addons:Ee,combineParameters:sd,controlOrMetaKey:nd,controlOrMetaSymbol:ad,eventMatchesShortcut:ld,eventToShortcut:cd,experimental_MockUniversalStore:dd,experimental_UniversalStore:hd,experimental_requestResponse:pd,experimental_useUniversalStore:ud,isMacLike:fd,isShortcutTaken:md,keyToSymbol:gd,merge:vd,mockChannel:yd,optionOrAltSymbol:bd,shortcutMatchesShortcut:xd,shortcutToHumanString:_d,types:it,useAddonState:wd,useArgTypes:$d,useArgs:Ed,useChannel:Sd,useGlobalTypes:Ad,useGlobals:Cd,useParameter:st,useSharedState:Md,useStoryPrepared:Td,useStorybookApi:Pd,useStorybookState:fo}=__STORYBOOK_API__;var Nr=Object.defineProperty,ct=(o,e)=>()=>(o&&(e=o(o=0)),e),Rr=(o,e)=>{for(var t in e)Nr(o,t,{get:e[t],enumerable:!0})},Ce,mo,go,vo,dt=ct(()=>{Ce=({config:o,defer:e=!1})=>{let[t,r]=P(e?void 0:o.url),[i,s]=P(!1);return N(()=>{if(!e)return;let n=requestAnimationFrame(()=>{r(o.url)});return()=>cancelAnimationFrame(n)},[e,o.url]),N(()=>{s(!1)},[t]),p("div",{css:mo},!i&&p(I,{css:go},"Loading..."),p("iframe",{css:vo,src:t,allowFullScreen:o.allowFullscreen,onLoad:()=>s(!0)}))},mo=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Fr=k`
  ...
  bottom: 0;
  left: 0;
`,Ur=({onZoomIn:o,onZoomOut:e,onReset:t})=>p(w,null,p(ce,{onClick:o},p(de,{icon:"zoom"})),p(ce,{onClick:e},p(de,{icon:"zoomout"})),p(ce,{onClick:t},p(de,{icon:"zoomreset"}))),Dr=(o,e)=>{let[t,r]=P(1);N(()=>{r(o)},e);let i=T(()=>{r(c=>c+.1)},[r]),s=T(()=>{r(c=>Math.max(c-.1,.1))},[r]),n=T(()=>{r(1)},[r]);return{scale:t,zoomIn:i,zoomOut:s,resetZoom:n}},jr=({config:o})=>{let e=Dr(o.scale||1,[o.scale]),t=W(()=>({transform:`scale(${e.scale})`}),[e.scale]);return p("div",{css:zr},p(pt,{border:!0},p(w,{key:"left"},p("p",null,p("b",null,"Image")),p(ut,null),p(Ur,{onReset:e.resetZoom,onZoomIn:e.zoomIn,onZoomOut:e.zoomOut}))),p(Hr,{css:Vr,defaultValue:o.offset},p("img",{css:Yr,src:o.url,style:t})))},zr=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
...
`,Wr=({config:o})=>p("div",{css:Gr},p(K,{cancel:!1,href:o.url,target:o.target??"_blank",rel:o.rel??"noopener",withArrow:o.showArrow??!0},o.label||o.url)),Gr=k`
  position: absolute;
  top: 0;
  right: 0;
  bottom: 0;
  ...
  align-items: center;
`;dt();var Zr=o=>{if(o.protocol!=="https:")return{valid:!1,error:p(w,null,"Expected HTTPS link, received ",p("code",null,o.protocol),".")};if(o.hostname!=="www.sketch.com")return{valid:!1,error:p(w,null,"Expected a hostname ",p("code",null,"www.sketch.com"),", received"," ",p("code",null,o.hostname))};let e=p(w,null,"Expected pathname ",p("code",null,"/s/<string>/a/<string>"),", received"," ",p("code",null,o.pathname),"."),t=o.pathname.split("/").slice(1);if(t.length<4)return{valid:!1,error:e};if(t[0]==="embed")return{valid:!0,data:{url:o.href,offscreen:!1}};let[r,i,s,n]=t;return r!=="s"||!i||s!=="a"||!n?{valid:!1,error:e}:{valid:!0,data:{url:`https://www.sketch.com/embed/s/${i}/a/${n}`,offscreen:!1}}},Xr=({config:o})=>{let e=W(()=>{let t=Zr(new URL(o.url));return t.valid?{...t,data:{...o,...t.data}}:t},[o]);return e.valid?p(Ce,{defer:!0,config:e.data}):p(I,null,p(w,null,"Invalid Sketch URL"),p(w,null,e.error))},qr=({tabs:o,deps:e=[]})=>{let[t,r]=P(o[0].id);return N(()=>{r(o[0].id)},e),p(ft,{absolute:!0,selected:t,actions:{onSelect:r}},o.map(i=>p("div",{key:i.id,id:i.id,title:i.name},i.offscreen||t===i.id?i.content:null)))},Kr=ke(()=>Promise.resolve().then(()=>(Br(),Eo))),Jr=({config:o})=>{if(!o||"length"in o&&o.length===0)return p(I,null,p(w,null,"No designs found"),p(w,null,"Learn how to"," ",p(K,{href:"https://github.com/storybookjs/addon-designs#3-add-it-to-story",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"display design preview for the story")));let e=[...o instanceof Array?o:[o]].map(t=>{let r={id:JSON.stringify(t),name:t.name||t.type?.toUpperCase()||"ERROR",offscreen:t.offscreen??!0};switch(t.type){case"iframe":return{...r,content:p(Ce,{config:t})};case"figma":return{...r,content:p(wo,{config:t}),offscreen:!1};case"sketch":return{...r,content:p(Xr,{config:t})};case"figspec":case"experimental-figspec":return t.type==="experimental-figspec"&&console.warn("[storybook-addon-designs] `experimental-figspec` is deprecated. We will remove it in v7.0. Please replace it to `figspec` type."),{...r,content:p(Pe,{fallback:"Preparing Figspec viewer..."},p(Kr,{config:t})),offscreen:!1};case"image":return{...r,content:p(jr,{config:t})};case"link":return{...r,content:p(Wr,{config:t})}}return{...r,content:p(I,null,p(w,null,"Invalid config type"),p(w,null,"Config type you set is not supported. Please choose one from"," ",p(K,{href:"https://github.com/storybookjs/addon-designs/blob/master/packages/storybook-addon-designs/src/config.ts",target:"_blank",rel:"noopener",withArrow:!0,cancel:!1},"available config types")))}});return e.length===1?p("div",null,e[0].content):p(qr,{tabs:e,deps:[o]})},_o=({active:o})=>{let e=fo(),t=st(Ae),[r,i]=P(o);return N(()=>{i(o)},[t]),N(()=>{o&&i(!0)},[o]),r?p(Jr,{key:e.storyId,config:t}):null},ae="Design";function Qr(o){Ee.register(Co,e=>{let t=function(){let r=st(Ae);return r?Array.isArray(r)?r.length>0?`${ae} (${r.length})`:ae:(r.name||ae)+" (1)":ae};o==="tab"?Ee.add(bo,{title:ae,render({active:r}){return r?p(xo,null,p(_o,{active:!0})):p("noscript",null)},type:it.TAB,paramKey:Ae}):Ee.add(bo,{type:it.PANEL,title:t,paramKey:Ae,render({active:r}){return p(ht,{active:!!r},p(xo,null,p(_o,{active:!!r})))}})})}Qr("panel");})();
